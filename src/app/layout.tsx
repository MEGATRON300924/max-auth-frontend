...
export const metadata: Metadata = {
  ...
  authors: [{ name: "The Tron Forge Limited" }],
  creator: "Zion Opaaje",
  ...
  openGraph: {
    ...
    locale: "en_US",
    type: "website",
    images: [{ url: "/logo.png", width: 512, height: 512, alt: "MAX Auth Logo" }],
  },
  twitter: {
  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        operatingSystem: "Web",
        url: "https://auth.max-ai.name.ng",
        description: "MAX Auth provides secure identity management for The MAX AI Ecosystem.",
        creator: { "@type": "Organization", name: "The Tron Forge Limited" },
      },
    ],
  };
