...
export interface OAuthClientConfig { applicationType: OAuthApplicationType; authorizedOrigins: string[]; packageName: string | null; bundleId: string | null; certificateFingerprints: string[]; }
